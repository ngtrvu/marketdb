...
DATE_RANGES = ["1d", "1w", "1m", "3m", "1y", "3y", "5y", "ytd", "all"]
HISTORICAL_DATE_RANGES = ["1w", "1m", "3m", "1y", "3y", "5y", "ytd", "all"]


class InternalStockPriceRealtimeDetailSerializer(serializers.ModelSerializer):
