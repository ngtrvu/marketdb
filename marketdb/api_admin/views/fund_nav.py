...
from core.models import FundNavAnalytics
from utils.date_range import get_range_dates
from core.models.funds.fund_nav import MutualFundNavDaily, MutualFundNavIndex
from api.serializers.fund_nav import MutualFundNavDetailSerializer


class MutualFundPriceDetailView(RetrieveAPIView):
    lookup_field = "symbol"
