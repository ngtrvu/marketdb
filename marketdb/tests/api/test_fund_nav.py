...
class FundPriceAnalyticsApiInternalTestCase(APITest):
    ...
    def test_get_fund_detail_success(self):
        url = reverse("api:mutual-fund-price-detail", args=["VCAMBF"])
    ...
    def test_get_fund_detail_have_no_performance(self):
        url = reverse("api:mutual-fund-price-detail", args=["VSAF"])
        response = self.client.get(url)
