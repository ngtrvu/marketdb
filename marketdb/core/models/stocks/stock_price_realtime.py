...
class StockPriceRealtime(BaseModel):
    """StockPriceRealtime contains realtime prices from exchange, including all stocks, ETFs,
    Market index, and Warrant
    """
    ...
    type = models.CharField(max_length=50, default=AssetType.STOCK, db_index=True)
