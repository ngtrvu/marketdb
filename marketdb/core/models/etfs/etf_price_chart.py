...
class ETFPriceChart(BaseModel):
    ...
    price_1d = models.DecimalField(max_digits=20, decimal_places=2, blank=True, null=True)
    volume_1d = models.DecimalField(max_digits=20, decimal_places=2, blank=True, null=True)
    ...
    volume_all = models.DecimalField(
        max_digits=20, decimal_places=2, default=0, blank=True, null=True
    )
    ...
    movement_all = models.JSONField(default=list, blank=True, null=True)
